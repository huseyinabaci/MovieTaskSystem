...
namespace TaskSystem.Common.Model
{
    public class ErrorInfo
    {
        ...
        {
            if (other != null && CorrelationId.Equals(other.CorrelationId) && Code == other.Code && Message == other.Message && Details == other.Details)
            {
                return Equals(ValidationErrors, other.ValidationErrors);
            }
